...
function revolution_press_customize_register_meta( $wp_customize ) {
	
	
		$wp_customize->selective_refresh->add_partial( 'hide_author', array(
			'selector' => '.entry-meta',
			'render_callback' => 'revolution_press_customize_partial_hide_author',
		) );		
	
		$wp_customize->add_section( 'revolution_press_hide_meta' , array(
			'title'       => __( 'Post Options', 'revolution-press' ),
			'priority'    => 26,			) );
		...
		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'hide_author', array(
			'label'    => __( 'Hide Author', 'revolution-press' ),
			'section'  => 'revolution_press_hide_meta',
			'priority'    => 3,				
		...
		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'hide_date', array(
			'label'    => __( 'Hide Calendar', 'revolution-press' ),
			'section'  => 'revolution_press_hide_meta',
			'priority'    => 3,				
			'settings' => 'hide_date',
			'type' => 'checkbox',
		...
		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'hide_comments', array(
			'label'    => __( 'Hide Comments Link', 'revolution-press' ),
			'section'  => 'revolution_press_hide_meta',
			'priority'    => 3,				
		...
		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'hide_posted_in', array(
			'label'    => __( 'Hide Posted in Category', 'revolution-press' ),
			'section'  => 'revolution_press_hide_meta',
			'priority'    => 3,				
		...
		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'hide_posted_tags', array(
			'label'    => __( 'Hide Tags', 'revolution-press' ),
			'section'  => 'revolution_press_hide_meta',
			'priority'    => 3,				
...
add_action( 'customize_register', 'revolution_press_customize_register_meta' );
function revolution_press_hide_meta_styles() {
...
add_action( 'wp_enqueue_scripts', 'revolution_press_hide_meta_styles' );