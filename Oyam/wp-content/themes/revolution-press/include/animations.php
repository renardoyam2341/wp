...
function revolution_press_animations_customize_register( $wp_customize ) {

/************************************   Animations  ***********************************************/

function revolution_press_animations(){
	$array = array(
				'default0' => esc_attr__( 'Deactivate Animation', 'revolution-press' ),			
				'fadeIn' => esc_attr__( 'fadeIn', 'revolution-press' ),
				'flipInX' => esc_attr__( 'flipInX', 'revolution-press' ),
				'flip' => esc_attr__( 'flip', 'revolution-press' ),
				'flipInY' => esc_attr__( 'flipInY', 'revolution-press' ),			
				...
				'headShake' => esc_attr__( 'headShake', 'revolution-press' ),
				'hinge' => esc_attr__( 'hinge', 'revolution-press' ),
				'jello' => esc_attr__( 'jello', 'revolution-press' ),
				...
				'zoomIn' => esc_attr__( 'zoomIn', 'revolution-press' ),
	...
	return $array;
		...
		function revolution_press_sanitize_animations( $input ) {

			$valid = revolution_press_animations();
...
/************************************** Site Title Animation ******************************************/	
		...
		$wp_customize->add_panel( 'revolution_press_animations' , array(
			'title'       => __( 'Animations', 'revolution-press' ),
			'priority'   => 4,
		) );
...
/************************************** Article Animation ******************************************/	
		...
		$wp_customize->add_section( 'revolution_press_content_animations' , array(
			'title'       => __( 'Article Scroll Animation', 'revolution-press' ),
			'panel'       => 'revolution_press_animations',
			'description' => __( 'Article Animation', 'revolution-press' ),
			'priority'   => 4,
		) );
		
		$wp_customize->add_setting( 'revolution_press_animation_content', array (
			'sanitize_callback' => 'revolution_press_sanitize_animations',
			'default' => 'zoomIn',
		) );
		
		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'revolution_press_animation_content', array(
			'label'    => __( 'Article Animation', 'revolution-press' ),
			'section'  => 'revolution_press_content_animations',
			'settings' => 'revolution_press_animation_content',
			'type'     =>  'select',
            'choices'  => revolution_press_animations(),
		) ) );
		
		$wp_customize->add_setting( 'revolution_press_animation_content_speed', array(
		    'sanitize_callback' => 'sanitize_text_field',
		) );
		$wp_customize->add_control( new WP_Customize_Range_Control( $wp_customize, 'revolution_press_animation_content_speed', array(
			'type' => 'range',
			'section' => 'revolution_press_content_animations',
			'label'       => __( 'Animation Speed / millisecond ', 'revolution-press' ),
			'input_attrs' => array(
				'min'  => 0.1,
				'max'  => 3,
				'step' => 0.1,
...
add_action( 'customize_register', 'revolution_press_animations_customize_register' );

/*********************************************************************************************************
*  Menu Animations
**********************************************************************************************************/

function revolution_press_style_menu_animation() {
 $menu_animation = get_theme_mod( 'revolution_press_sub_menu_animation' ); 
	...
	add_action( 'wp_enqueue_scripts', 'revolution_press_style_menu_animation' );