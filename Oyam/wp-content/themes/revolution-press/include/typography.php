<?php
	...
	/******************************
		* Font Sanitize
	******************************/
	function revolution_press_array_fonts() {
		$array = array(
		'' => esc_attr__( 'inherit', 'revolution-press' ),		
		'Helvetica' => esc_attr__( 'Helvetica', 'revolution-press' ),
		'Arial' => esc_attr__( 'Arial', 'revolution-press' ),
		'Oswald' => esc_attr__( 'Oswald', 'revolution-press' ),
		'Verdana' => esc_attr__( 'Verdana', 'revolution-press' ),
		'Tahoma' => esc_attr__( 'Tahoma', 'revolution-press' ),
		'Trebuchet MS' => esc_attr__( 'Trebuchet MS', 'revolution-press' ),
		'Impact' => esc_attr__( 'Impact', 'revolution-press' ),
		'Times New Roman' => esc_attr__( 'Times New Roman', 'revolution-press' ),
		'Courier' => esc_attr__( 'Courier', 'revolution-press' ),
		);
		return $array;
	}
	function revolution_press_sanitize_fonts( $input ) {
		$valid = revolution_press_array_fonts();
	...
	/******************************
		* Font Wight Sanitize
	******************************/
	function revolution_press_array_font_weight() {
		$array = array(
		'' => esc_attr__( 'Inherit', 'revolution-press' ),		
		'100' => esc_attr__( 'Thin 100', 'revolution-press' ),
		'200' => esc_attr__( 'Extra Light 200', 'revolution-press' ),
		'300' => esc_attr__( 'Light 300', 'revolution-press' ),
		'400' => esc_attr__( 'Normal 400', 'revolution-press' ),
		'500' => esc_attr__( 'Medium 500', 'revolution-press' ),
		'600' => esc_attr__( 'Semi Bold 600', 'revolution-press' ),
		'700' => esc_attr__( 'Bold 700', 'revolution-press' ),
		'800' => esc_attr__( 'Extra Bold 800', 'revolution-press' ),
		'900' => esc_attr__( 'Ultra Bold 900', 'revolution-press' ),
		);
		return $array;
	}
	function revolution_press_sanitize_fonts_weight( $input ) {
		$valid = revolution_press_array_font_weight();
		if ( array_key_exists( $input, $valid ) ) {
			return $input;
			} else {
			return '';
	...
	******************************/
	function revolution_press_array_text_transform() {
		$array = array(
		'inherit' => esc_attr__( 'Inherit', 'revolution-press' ),		
		'' => esc_attr__( 'None', 'revolution-press' ),
		'capitalize' => esc_attr__( 'Capitalize', 'revolution-press' ),
		'uppercase' => esc_attr__( 'Uppercase', 'revolution-press' ),
		'lowercase' => esc_attr__( 'Lowercase', 'revolution-press' ),
		);
		return $array;
	}
	function revolution_press_sanitize_text_transform( $input ) {
		$valid = revolution_press_array_text_transform();
		if ( array_key_exists( $input, $valid ) ) {
			return $input;
			} else {
			return '';
	...
	******************************/
	...
	function revolution_press_array_font_style() {
		$array = array(
		'inherit' => esc_attr__( 'Inherit', 'revolution-press' ),		
		'italic' => esc_attr__( 'Italic', 'revolution-press' ),
		);
		return $array;
	}
	function revolution_press_sanitize_font_style( $input ) {
		$valid = revolution_press_array_font_style();
		if ( array_key_exists( $input, $valid ) ) {
			return $input;
			} else {
			return '';
	...
	******************************/
	...
	function revolution_press_sanitize_float( $input ) {
		return filter_var($input, FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION);
	}
	
	add_action( 'customize_register', 'revolution_press_typography_customize' );
	function revolution_press_typography_customize( $wp_customize ) {
		
		$wp_customize->add_panel( 'seos_typography_panel' , array(
		'title'       => __( 'Typography', 'revolution-press' ),
		'priority'    => 6,
		) );
		...
		'title'       => __( 'Site Title', 'revolution-press' ),
		'priority'    => 1,
		) );
		...
		******************************/		
		...
		'label'       => __( 'Font Size / px', 'revolution-press' ),
		'description' => __( 'When the range is null, the default value is set.', 'revolution-press' ),		
		'type'     =>  'range',
		'input_attrs'     => array(
		'min'  => 0,
		'max'  => 100,
		...
		******************************/		
		...
		'label'       => __( 'Mobile Font Size / px', 'revolution-press' ),
		'description' => __( 'When the range is null, the default value is set.', 'revolution-press' ),		
		'type'     =>  'range',
		'input_attrs'     => array(
		'min'  => 0,
		...
		******************************/
		...
		'sanitize_callback' => 'revolution_press_sanitize_float',
		) );
		...
		'section'  => 'typography_site_title',
		'label'       => __( 'Line Hight / em', 'revolution-press' ),
		'description' => __( 'When the range is null, the default value is set.', 'revolution-press' ),		
		'input_attrs' => array(
		'min'  => 0,
		'max'  => 5,
		...
		******************************/		
		...
		'priority' => 9,
		'section' => 'typography_site_title',
		'label'       => __( 'Letter Spacing / px', 'revolution-press' ),
		'description' => __( 'When the range is null, the default value is set.', 'revolution-press' ),			
		'input_attrs' => array(
		'min'  => 0,
		'max'  => 10,
		...
		'panel'       => "seos_typography_panel",
		'title'       => __( 'Site Description', 'revolution-press' ),
		'priority'    => 1,
		) );
		/******************************
			* Font
		...
		******************************/		
		...
		'panel'       => "seos_typography_panel",
		'title'       => __( 'Titles', 'revolution-press' ),
		'priority'    => 1,
		) );
		/******************************
			* Font
		...
		******************************/
		...
		'panel'       => "seos_typography_panel",
		'title'       => __( 'Content', 'revolution-press' ),
		'priority'    => 1,
		) );
		/******************************
			* Font
	...
	add_action( 'wp_enqueue_scripts', 'revolution_press_typography_styles' );	
	function revolution_press_typography_styles() {
